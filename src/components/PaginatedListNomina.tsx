      ...
      <ul className='empleado-items'>
        {currentItems.length > 0 ? (
          ...
          <div className='empleado-item' key={item.id_empleado}>
            ...
            <NavLink className={"link"} to="/administrador/calculo-nomina" >Calculo manual</NavLink>
            <NavLink className={"link"} to="/administrador/calcular-nomina" >Calculo automático</NavLink>
          </div>)
        ) : (
